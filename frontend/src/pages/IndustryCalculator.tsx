...
const IndustryCalculator = () => {
  ...
  const handleCalculate = async () => {
    ...
    setError(null);
    try {
      const response = await fetch('http://localhost:8000/industry-diversify', {
        method: 'POST',
        headers: {
          ...
          <Paper sx={{ p: 3, backgroundColor: '#f8faff' }}>
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <TextField
                ...
                onChange={(e) => setInputs({ ...inputs, budget_dollars: Number(e.target.value) })}
                InputProps={{
              ...
              <Slider
                value={inputs.budget_dollars}
                onChange={(_, value) => setInputs({ ...inputs, budget_dollars: value as number })}
                min={1000}
                max={100000}
                step={1000}
                marks={[
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <Slider
                ...
                onChange={(_, value) => setInputs({ ...inputs, risk_tolerance: value as number })}
                min={0}
                max={2}
                step={0.1}
                marks={[
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <Slider
                ...
                onChange={(_, value) => setInputs({ ...inputs, max_companies: value as number })}
                min={2}
                max={20}
                step={1}
                marks={[
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <Slider
                ...
                onChange={(_, value) => setInputs({ ...inputs, min_value: (value as number) / 100 })}
                min={1}
                max={20}
                step={1}
                marks={[
            ...
            <Box>
              ...
              <Slider
                ...
                onChange={(_, value) => setInputs({ ...inputs, min_industries: value as number })}
                min={1}
                max={5}
                step={1}
                marks={[
